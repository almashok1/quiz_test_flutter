  ...
  Widget build(BuildContext context) { 
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        child: Center(
          child: Text(LocalizationKeys.all).tr()
        )
      ),
      appBar: AppBar(
        ...
        title: TextField(
          ...
          controller: _controller,
            ...
            decoration: InputDecoration(
                ...
                border: InputBorder.none, hintText: LocalizationKeys.search_title_hint_text.tr())
          ),
      ),
        body: Container(
          ...
          foundQuestions.add(
            Card(
              ...
              child: ListTile(
                ...
                subtitle: Text(
                  i+1<list.length ? list[i+1].replaceFirst("<variant>", "").trim() : LocalizationKeys.search_no_data.tr(),
