...
class TestModeSegment extends StatefulWidget {
  final int _questionNumber;
  TestModeSegment(this._questionNumber);

  @override
  _TestModeSegmentState createState() => _TestModeSegmentState();
}

class _TestModeSegmentState extends State<TestModeSegment> {
